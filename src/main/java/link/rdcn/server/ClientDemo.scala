...
//  }
  ...
  def main(args: Array[String]): Unit = {
//    val dacpServer = new DftpServer(new DataProviderTest, new DataReceiverTest, new AuthorProviderTest)
//    dacpServer.start(new FairdConfig)
    val dacpClient = DftpClient.connect("dftp://10.0.90.43:3102", UsernamePassword("15117913512@126.com", "admin#U*Q!."))

    val dfDataSets = dacpClient.get("dftp://10.0.90.43:3102/listDataSets")
